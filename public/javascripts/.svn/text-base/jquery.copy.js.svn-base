...
jQuery.copy=function(t)
{
	...
	else
	{
		...
		var i='<embed src="http://coryandrobtest.com/swf/copy.swf" FlashVars="clipboard='+encodeURIComponent(t)+'" width="0" height="0" type="application/x-shockwave-flash"></embed>';
